    ...
    <div className={styles.page_flexBox}>
      <div className={styles.page_container}>
        ...
        <div className={styles.nft_info}>
          ...
          <p className={styles.text}>
            This NFT is on Polygon zkEVM Testnet! 🚀 You’ll need some test zkEVM
            ETH to mint the NFT.{" "}
            <a href="https://wallet.polygon.technology/?redirectOnConnect=%2FzkEVM%2Fbridge">
              Bridge over Goerli ETH to zkEVM testnet ETH
            </a>
          </p>
          {isDisconnected ? (
